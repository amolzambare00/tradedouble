...
createdBy varchar(256), createdDate datetime, lastModifiedBy varchar(256), lastModifiedDate datetime, 
PRIMARY KEY (id)) 
...
createdBy varchar(256), createdDate datetime, lastModifiedBy varchar(256), lastModifiedDate datetime, PRIMARY KEY (id)) 
ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_0900_ai_ci;
...
fk_fieldid bigint NOT NULL, value varchar(512), createdBy varchar(256), createdDate datetime, lastModifiedBy varchar(256), lastModifiedDate datetime,
PRIMARY KEY (id), 
...
height int, width int, createdBy varchar(256), createdDate datetime, lastModifiedBy varchar(256), lastModifiedDate datetime, 
